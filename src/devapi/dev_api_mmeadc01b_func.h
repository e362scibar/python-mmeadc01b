...
extern   int    dev_mmeadc01b_get_completion_status         (int fd, uint32_t  *cmplt);
extern   int    dev_mmeadc01b_start_dma_xfer                (int fd, uint32_t req_acq, int idx_ring);
extern   int    dev_mmeadc01b_get_meta                      (int fd, mmeadc01b_xfer_meta_t *xm);
extern   int    dev_mmeadc01b_clear_dma_buf_status          (int fd);
extern   int    dev_mmeadc01b_register_interrupt_callback   (int fd, void  *cb     , int  pid);
extern   int    dev_mmeadc01b_unregister_interrupt_callback (int fd);
